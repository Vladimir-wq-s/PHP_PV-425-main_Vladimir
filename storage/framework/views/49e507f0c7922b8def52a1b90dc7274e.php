<?php $__env->startSection('content'); ?>
        ...
        <?php if(count($products) > 0): ?>
            ...
            <div class="row g-4" id="productsGrid">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 product-card" data-category="<?php echo e($product->category_id); ?>">
                        <div class="card h-100 border-0 shadow-sm hover-shadow transition-all rounded-4 overflow-hidden">
                            ...
                            <div class="card-body p-3">
                                ...
                                <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-2 py-1 mb-2">
                                    ...
                                    <?php echo e($product->category->name ?? 'Без категории'); ?>
                                    ...
                                    <div class="d-flex flex-wrap gap-1 mb-2">
                                        <?php $__currentLoopData = $product->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge rounded-pill px-2 py-1" style="
                                                background: <?php echo e($tag->color ?? '#6c757d'); ?>;
                                                color: white;
                                                font-size: 0.65rem;
                                                font-weight: 500;
                                                opacity: 0.9;
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-2">
                                    <div>
                                        ...
                                        <?php if($product->price > 20000): ?>
                                            <span class="text-muted text-decoration-line-through ms-2 small">
                                                <?php echo e(number_format($product->price * 1.2, 0, ',', ' ')); ?> ₽
                                            </span>
                                        <?php endif; ?>
                                    </div>
    ...
    <script>
        ...
        function quickView(productId) {
            ...
            document.getElementById('quickViewImage').src = '<?php echo e(asset("storage/ps5i.webp")); ?>';
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PHP Project\PV-425-main\resources\views/home.blade.php ENDPATH**/ ?>